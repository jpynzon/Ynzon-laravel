            ...
            <div class="container text-center mt-5">
                ...
                <div class="cards d-flex flex-wrap justify-content-center">
                    <div
                        ...
                        <h5 class="title fw-bold my-3">ADDRESS</h5>
                        <span class="desc">Daanlungsod, Toledo City 6038</span>
                    </div>
                    ...
                    <div
                        ...
                        <h5 class="title fw-bold my-3">PHONE</h5>
                        <span class="desc">09615740800</span>
                    </div>
                    ...
                    <div
                        ...
                        <h5 class="title fw-bold my-3">EMAIL</h5>
                        <span class="desc">joshuapauloynzon@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
...
<style scoped>
/* Add any styles you need for the content here */
</style>
